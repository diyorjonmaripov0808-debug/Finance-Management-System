    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(max_length=13, unique=True, validators=[django.core.validators.RegexValidator(message="Telefon raqam formati: '+998901234567'", regex='^\\+998[0-9]{9}$')], verbose_name='Telefon raqam')),
                ('auth_status', models.CharField(choices=[('NEW', 'Yangi'), ('CODE_VERIFIED', 'Kod tasdiqlangan'), ('CLIENT', 'Mijoz')], default='NEW', max_length=20, verbose_name='Holat')),
